    ...
    return (
      <div className={'YoutuberChannelCard-zone'}>
        ...
        <div className={'YoutuberChannelCard-frontZone'}>
          ...
          <h2 className={'YoutuberChannelCard-data'}><small>來自 {channelInfo.country || '無'}</small></h2>
          <h2 className={'YoutuberChannelCard-data'}><small>地區 {parseInt(month/12, 10) + '年' + month%12 + '個月'}</small></h2>
        </div>
